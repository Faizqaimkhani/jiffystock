@extends('new-layouts.dashboard.layouts.app', ['activePage' => 'advertisements','namePage' => 'Jiffystock Advertisement Management'])
                ...
                <table class="table">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                          @if($p->status==0)
                              <a class="btn btn-primary" href="{{route('add-approve',$p->id)}}">Approve</a>
                              <a class="btn btn-danger" href="{{route('add-reject',$p->id)}}">Reject</a>
                          @endif
                          </td>
                      </tr>
                      @endforeach
