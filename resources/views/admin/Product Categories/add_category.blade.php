@extends('new-layouts.dashboard.layouts.app', ['activePage' => 'notification','namePage' => 'Jiffystock Add Category'])
        ...
        <div class="card card-statistics">
            <div class="card-body">
              ...
              <div class="card-title">
                ...
                <form action="/products-category" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    <div class="col">
