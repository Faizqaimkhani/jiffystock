@extends('new-layouts.dashboard.layouts.app', ['activePage' => 'admin_wallet','namePage' => 'Jiffystock Admin Wallet Management'])
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <h2>${{isset($wallet->price)==true?$wallet->price:0}}</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-5">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <h3>${{isset($wallet->deposits)?$wallet->deposits:0}}</h3>
                                <div class="mt-3">
