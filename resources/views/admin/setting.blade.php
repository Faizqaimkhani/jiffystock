@extends('new-layouts.dashboard.layouts.app', ['activePage' => 'admin_settings','namePage' => 'Jiffystock Admin Settings'])
...
<div class="container mt-5">
  <div class="row">
    <div class="card col-md-12 rounded">
      ...
      <div class="card-body">
      <form action="{{route('user.setting.save',$item->id)}}" method="POST">
            @csrf
        <div class="row">
          ...
          <div class="form-group col-md-6">
            <label for="company">Company License </label>
            <input type="text" class="form-control" name="company_license" value="{{$item->company_license}}">
          </div>
          <div class="form-group col-md-6">
          ...
          <div class="form-group text-center">
            <input type="submit" class="btn btn-success ml-4 mt-4" >
          </div>
          </form>
        </div>
      </div>
    ...
    <div class="card col-md-12 rounded">
     ...
     <div class="col-lg-6 mb-30">
            <div class="create_wrapper mw-100">
                ...
                <form class="create_ticket_form row mb-30-none" method="POST" action="{!! route('user.password.save',$item->id) !!}">
                    @csrf
