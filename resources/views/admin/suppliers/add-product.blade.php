            ...
            <div class="card card-statistics">
                <div class="card-body">
                  <div class="container">
                    ...
                    <form action="{{ route('admin.supplier.product.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mt-4">
                            <div class="col">
                                ...
                                @foreach ($colors as $c)
                                <input type="checkbox" class="ml-4" name="color[]" value="{{$c->id}}">
                                <label for="vehicle1" style="background: {{$c->code}}" class="border-dark"
                                    id="circle"></label>
                                @endforeach
                            </div>
                        </div>
