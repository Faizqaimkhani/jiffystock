                            ...
                            <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $request->price }}</td>
                                            <td><a class="btn btn-primary" href="{{route('request-approve',['sell',base64_encode($request->id)])}}">Approved</a>
                                                <a class="btn btn-danger" href="{{route('request-cancel',['sell',base64_encode($request->id)])}}">Cancel</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
