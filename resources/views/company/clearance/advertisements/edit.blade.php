...
<div class="main-panel">
  @include('company.layouts.navbars.navs.auth', ["namePage" => "Clearance Edit Advertisement"])
            ...
            <div class="card card-statistics">
              ...
              <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('clearance.advertisement.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col">
                                ...
                                <br>
                                <img src="{{ asset('storage/uploads/clearance/advertisement-images/' . $add->image) }}"
                        ...
                        <div class="mt-4 mb-2">
                            ...
                            <a href="{{ route('clearance.advertisement') }}" class="btn btn-warning">Cancel</a>
                        </div>
                    </form>
                  </div>
                </div>
