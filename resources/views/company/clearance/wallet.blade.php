...
@include('company.layouts.clearance-sidebar',['activePage' => 'wallet'])

@section('content')
<div class="main-panel">
  @include('company.layouts.navbars.navs.auth', ["namePage" => "Clearance Wallet"])
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <h2>${{auth('clearance_user')->user()->admin_wallet ? auth('clearance_user')->user()->admin_wallet->price : 0 }}</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-5">
...
<!-- end container-fluid -->
    ...
    {{-- Deposit now modal --}}
    <div class="modal fade" id="depositModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
...
width="64" height="64"
viewBox="0 0 172 172"
style=" fill:#000000;"><g transform="translate(1.72,1.72) scale(0.98,0.98)"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none" stroke="none"></path><g stroke="none"><g><rect x="1" y="1" transform="scale(2.6875,2.6875)" width="62" height="62" rx="6" ry="0" fill="#005699"></rect><path d="M153.1875,2.6875h-134.375c-8.90559,0 -16.125,7.21941 -16.125,16.125v26.875c0,32.65384 26.47116,59.125 59.125,59.125h48.375c32.65384,0 59.125,-26.47116 59.125,-59.125v-26.875c0,-8.90559 -7.21941,-16.125 -16.125,-16.125z" fill="#0178bc"></path><path d="M153.1875,2.6875h-134.375c-8.90559,0 -16.125,7.21941 -16.125,16.125v10.75c0,-8.90559 7.21941,-16.125 16.125,-16.125h134.375c8.90559,0 16.125,7.21941 16.125,16.125v-10.75c0,-8.90559 -7.21941,-16.125 -16.125,-16.125z" fill="#0291d5"></path><path d="M153.1875,158.5625h-134.375c-8.90559,0 -16.125,-7.21941 -16.125,-16.125v10.75c0,8.90559 7.21941,16.125 16.125,16.125h134.375c8.90559,0 16.125,-7.21941 16.125,-16.125v-10.75c0,8.90559 -7.21941,16.125 -16.125,16.125z" fill="#00457a"></path><path d="M61.30188,118.25l8.4925,-37.65187l0.08062,0.02687h18.8125c13.35839,0 24.1875,-10.82911 24.1875,-24.1875c13.35839,0 24.1875,10.82911 24.1875,24.1875c0,13.35839 -10.82911,24.1875 -24.1875,24.1875h-21.5l-10.75,34.9375h-24.1875z" fill="#add1e9"></path><path d="M83.85,56.4375h29.025c0,13.35839 -10.82911,24.1875 -24.1875,24.1875h-18.8125l-0.08062,-0.02688l3.57437,-15.77563c1.10524,-4.90075 5.45741,-8.38249 10.48125,-8.385z" fill="#e6eff6"></path><path d="M112.875,56.4375h-29.025c-5.02384,0.00251 -9.37601,3.48425 -10.48125,8.385l-3.57438,15.77563l-8.4925,37.65187h-26.36437l17.89875,-81.78062c0.53353,-2.46617 2.71741,-4.22447 5.24063,-4.21937h30.61063c13.3498,0.02072 24.16678,10.8377 24.1875,24.1875z" fill="#fdfef9"></path><path d="M36.70319,118.25l-1.76569,8.0625h24.53956l1.82481,-8.0625z" fill="#00457a"></path><path d="M112.875,104.8125h-21.5l-10.75,34.9375h-22.36269l-1.82481,8.0625h24.1875l10.75,-34.9375h21.5c7.13185,0.04101 13.91408,-3.08539 18.51498,-8.53486c4.60091,-5.44947 6.5459,-12.65987 5.30971,-19.68389c-1.96558,11.62856 -12.03118,20.1443 -23.82469,20.15625z" fill="#00457a"></path></g></g><path d="" fill="none" stroke="none"></path><path d="" fill="none" stroke="none"></path></g></g></svg></div>
<div>
<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
  ...
  $('form.validation').bind('submit', function(e) {
    var $form         = $(".validation"),
        inputVal = ['input[type=email]', 'input[type=password]',
                         ...
                         'input[type=number]', 'textarea'].join(', '),
