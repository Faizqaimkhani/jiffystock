...
<div class="main-panel">
  @include('company.layouts.navbars.navs.auth', ["namePage" => "Shipment Add Advertisement"])
            ...
            <div class="card card-statistics">
              ...
              <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('shipment.advertisement.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col">
