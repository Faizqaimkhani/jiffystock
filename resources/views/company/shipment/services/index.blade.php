    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-statistics">
                <div class="card-body">
                      <h4 class="card-title">Shipment Services Management</h4>
                    ...
                    <div class="text-right">
                      <a href="{{route('shipment.service.create')}}" class="btn btn-info">Create Service</a>
                    </div>
                            ...
                            <tbody>
                              @foreach($services as $service)
                                <tr>
                                  ...
                                  <td>
                                    <div class="btn-group">
                                      <form action="{{route('shipment.service.delete')}}" method="POST">
                                        @csrf
                                        ...
                                        <a href="{{route('shipment.service.show',$service->id)}}" type="submit" name="button" class="text-white btn bg-info px-2 border-0 rounded " >
