...
<div class="main-panel">
  @include('company.layouts.navbars.navs.auth', ["namePage" => "Shipment Edit Service"])
        ...
        <div class="col-lg-12">
            <div class="card card-statistics">
              ...
              <div class="card-header">
                ...
                <div class="card-body">
                  <form action="{{route('shipment.service.update')}}" method="POST"  enctype="multipart/form-data">
                    @csrf
  ...
  @endif
                      <input type="text" name="title" class="form-control" value="{{$shipment->title}}">
                    </div>
                    <div class="form-group">
  ...
  @endif
                      ...
                      <img id="output" src="{{$shipment->thumbnail}}"/>
                    </div>
