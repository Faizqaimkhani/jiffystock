...
@include('company.layouts.shipment-sidebar',['activePage' => 'wallet'])

@section('content')
<div class="main-panel">
    @include('company.layouts.navbars.navs.auth', ["namePage" => "Shipment Wallet"])
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <h2>${{auth('shipment_user')->user()->admin_wallet ? auth('shipment_user')->user()->admin_wallet->price : 0}}</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-5">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <h3>${{auth('shipment_user')->user()->admin_wallet ? auth('shipment_user')->user()->admin_wallet->deposit : 0}}</h3>
                                <div class="mt-3">
