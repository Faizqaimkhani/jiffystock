@extends('new-layouts.dashboard.layouts.app',['namePage' => "Jiffystock Customer Wallet", 'activePage' => 'wallet'])
            ...
            <div class="card">
                <div class="p-5">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="my-input">Buy Products</label>
                                <h3>${{$wallet->buy_products}}</h3>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            @include('includes.customer-paypal')
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="depositModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <form role="form" action="{{route('deposit-in-customer-wallet')}}" method="post" class="validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
        @csrf
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Deposit Now Through Stripe</h5>
    ...
    <form action="{{route('customer-withdraw-request')}}" method="post">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" name="customer_id" value="{{$wallet->customer_id}}">
