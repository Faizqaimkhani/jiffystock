                ...
                <nav class="navbar navbar-expand-md">
                    ...
                    <div class="navbar-header d-flex align-items-center">
                        ...
                        <a class="navbar-brand" href="/">
                            ...
                            <img src="{{asset('frontend/images/logos/png/logo.png')}}" class="img-fluid logo-mobile" alt="logo" />
                        </a>
                    </div>
                                    ...
                                    <div class="dropdown-menu animated fadeIn" aria-labelledby="navbarDropdown">
                                        <div class="bg-gradient px-4 py-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="mr-1">
                                                    <h4 class="text-white mb-0">{{Auth::guard('customer')->user()->name}}</h4>
                                                    <small class="text-white">{{Auth::guard('customer')->user()->email}}</small>
                                                </div>
                ...
                <aside class="app-navbar">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li><a href="/customer-wallet" aria-expanded="false"><i class="nav-icon ti ti-wallet"></i><span class="nav-title">Wallet</span></a> </li>
                            <li><a href="{{route('customer-bids')}}" aria-expanded="false"><i class="nav-icon ti ti-hand-open"></i><span class="nav-title">Bids</span></a> </li>
                            <li><a href="{{route('setting')}}" aria-expanded="false"><i class="nav-icon ti ti-settings"></i><span class="nav-title">Setting</span></a> </li>
                            ...
                            <li><a href="{{route('customer_chat')}}" aria-expanded="false"><i class="nav-icon ti ti-email"></i><span class="nav-title">Contact Supplier  <span class="notify"> @if(auth('customer')->check())
                            {{getunread(auth('customer')->id())}}
                            @else
                            0
                            @endif
                            </span></span></a> </li>
