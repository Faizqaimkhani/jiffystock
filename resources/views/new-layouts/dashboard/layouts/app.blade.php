...
<head>
  ...
  <link href="{{ asset('new-frontend/css') }}/demo.css" rel="stylesheet" />
...
<body class="{{ $class ?? '' }}">
  <div class="wrapper">
    @authguard('customer')
      @include('new-layouts.dashboard.layouts.navbars.customer-sidebar')
    @else
      @include('new-layouts.dashboard.layouts.navbars.sidebar')
    @endauthguard
    <div class="main-panel">
      @authguard('customer')
        @include('new-layouts.dashboard.layouts.navbars.navs.customer-auth')
      @else
  ...
  <script src="{{ asset('new-frontend/js') }}/demo.js"></script>
  <!--  Google Maps Plugin    -->
