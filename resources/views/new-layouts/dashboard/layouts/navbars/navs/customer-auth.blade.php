    ...
    <div class="collapse navbar-collapse justify-content-end" id="navigation">
      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" aria-haspopup="true" aria-expanded="false"  data-toggle="dropdown" >
          ...
          <div class="dropdown-menu dropdown-menu-right px-4" aria-labelledby="navbarDropdownMenuLink">
            <small class="dropdown-item">{{Auth::guard('customer')->user()->email}} </small>
