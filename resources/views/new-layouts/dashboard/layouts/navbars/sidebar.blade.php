...
-->
  ...
  <div class="sidebar-wrapper" id="sidebar-wrapper">
    <ul class="nav">
      ...
      <li class="@if ($activePage == 'reports') active @endif"><a href="{{ route('product.reports') }}" aria-expanded="false"><i class="now-ui-icons design_app"></i><p>Reports</p></a> </li>
      ...
      <li class="@if ($activePage == 'send_email') active @endif"><a href="{{ route('send.email') }}" aria-expanded="false"><i class="now-ui-icons design_app"></i><p>Send Email</p></a></li>
      ...
      <li class="@if ($activePage == 'admin_orders') active @endif"><a href="{{route('orders')}}" aria-expanded="false"><i class="now-ui-icons design_app"></i><p>Orders</p></a> </li>
      <li class="@if ($activePage == 'supplier_chat') active @endif"><a href="{{route('supplier.chat')}}" aria-expanded="false"><i class="now-ui-icons design_app"></i><p>Conversation</p></a> </li>
       @endif
    </ul>
  </div>
</div>
